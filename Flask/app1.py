...
model = pickle.load(open('C:/Users/HP/Desktop/Prndrive/House Rant Prediction Fresh-Completed docx left/House Rent Prediction - With IBM Deployment/Flask- UI/rf_rand_model.pkl', 'rb'))
